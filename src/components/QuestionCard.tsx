...
const styles = StyleSheet.create({
  ...
  insightText: { fontSize: 15, color: colors.textPrimary, lineHeight: 23, fontWeight: '500' },
  ...
  scienceText: { fontSize: 14, color: colors.textSecondary, lineHeight: 21, fontWeight: '500' },
